 ...
 */
export declare type DendronConfigEntry<T = any> = {
    value?: T;
    label: string;
    desc: string;
};
 ...
 */
export declare type DendronConfigEntryCollection<T> = {
...
export declare type VaultSyncMode = keyof typeof VaultSyncModeEnum;
