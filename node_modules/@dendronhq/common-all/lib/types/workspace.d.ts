...
export declare type RemoteEndpoint = {
    type: "git";
    url: string;
};
...
export declare type DWorkspace = {
    name: string;
    vaults: DVault[];
    remote: RemoteEndpoint;
};
export declare type DWorkspaceEntry = Omit<DWorkspace, "name" | "vaults">;
...
export declare enum LegacyNoteAddBehavior {
...
export declare enum LegacyLookupSelectionType {
    "selection2link" = "selection2link",
    "selectionExtract" = "selectionExtract",
    "none" = "none"
}
export declare type LegacyNoteLookupConfig = {
    selectionType: LegacyLookupSelectionType;
    leaveTrace: boolean;
};
export declare type LegacyLookupConfig = {
    note: LegacyNoteLookupConfig;
};
export declare enum LegacyInsertNoteLinkAliasMode {
    "snippet" = "snippet",
    "selection" = "selection",
    "title" = "title",
    "prompt" = "prompt",
...
export declare type LegacyInsertNoteLinkConfig = {
    aliasMode: LegacyInsertNoteLinkAliasMode;
    multiSelect: boolean;
};
export declare type LegacyJournalConfig = {
    dailyDomain: string;
    /**
...
export declare type LegacyScratchConfig = Pick<LegacyJournalConfig, "name" | "dateFormat" | "addBehavior">;
export declare type DendronConfig = {
     ...
     */
    workspaces?: {
        [key: string]: DWorkspaceEntry | undefined;
    };
    seeds?: {
        [key: string]: SeedEntry | undefined;
    };
    /**
...
export declare type LegacyRandomNoteConfig = {
    /**
...
export declare type LegacyInsertNoteIndexConfig = {
    /**
...
export declare type LegacyDendronGraphConfig = {
    zoomSpeed: number;
};
export declare type LegacyHierarchyConfig = {
...
export declare type LegacyCustomFMEntry = {
    key: string;
    value: any;
};
export declare type CleanDendronSiteConfig = DendronSiteConfig & Required<Pick<DendronSiteConfig, "siteIndex" | "siteUrl">>;
export declare enum LegacyDuplicateNoteAction {
    USE_VAULT = "useVault"
}
export declare type LegacyUseVaultBehaviorPayload = {
    vault: DVault;
} | string[];
export declare type LegacyUseVaultBehavior = {
    action: LegacyDuplicateNoteAction;
    payload: LegacyUseVaultBehaviorPayload;
};
export declare type LegacyDuplicateNoteBehavior = LegacyUseVaultBehavior;
