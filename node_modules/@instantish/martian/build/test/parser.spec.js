...
describe('gfm parser', () => {
    it('should parse paragraph with nested annotations', () => {
        ...
        const actual = internal_1.parseBlocks(ast);
        const expected = [
            notion.paragraph([
    ...
    it('should parse rich text', () => {
        const ast = md.root(md.paragraph(md.text('a'), md.strong(md.emphasis(md.text('b')), md.text('c')), md.link('https://example.com', markdown_1.text('d'))));
        const actual = internal_1.parseRichText(ast);
        const expected = [
            notion.richText('a'),
