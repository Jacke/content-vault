...
[GitHub - sergeche/create-ilf-editor: Проект редактора для конференции "Я ❤️ Фронтэнд"](https://github.com/sergeche/create-ilf-editor)
...
[Setting Up | Atlas](https://atlasgo.io/cli/getting-started/setting-up)